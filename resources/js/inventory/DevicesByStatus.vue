    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">{{$route.params.status | capitalize}} Inventory Devices</h3>
            ...
            <div class="card-body">
                <table class="table table-striped table-hover">
                    ...
                    <tbody v-if="devices.data != null && devices.data.length > 0">
...
export default {
    ...
    methods: {
        ...
        getAllInitials(page = 1) {
            this.$Progress.start();
            axios.get('/api/inventory/devices/status?status='+this.$route.params.status +'&page='+page)
            .then(response => {
                this.refreshPage(response);
                this.$Progress.finish();
                toast.fire({
